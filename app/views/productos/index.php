                  ...
                  <table class="table pt-3" id="table_1">
                    ...
                    <?php foreach ($productos as $producto) { ?>                         
                      <tr>
                        ...
                        <td><?php echo $producto['product_reference'] ?></td>
                        <td><?php echo $producto['product_price'] ?></td>
                        <td><?php echo $producto['product_weight'] ?></td>
                        <td><?php echo $producto['name_category'] ?></td>
                        <td><?php echo $producto['product_stock'] ?></td>
                        <td><?php echo $producto['product_create_date'] ?></td>
                        <td>
                            <a class="dropdown-item" href="javascript:void(0);" onclick="editProducts(<?php echo $producto['product_id'];  ?>)"><i class="bx bx-edit-alt me-1"></i></a>
                            <a class="dropdown-item" href="javascript:void(0);" onclick="deleteProducts(<?php echo $producto['product_id']; ?>)" ><i class="bx bx-trash me-1"></i></a>
                        </td>
                      </tr>
                      <?php } ?>
